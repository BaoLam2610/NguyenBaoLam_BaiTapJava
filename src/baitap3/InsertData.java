    ...
    public void insertData_Sach() {
       ...
       public void insertData_ChiTietSach() {
        String query = "insert into ChiTietSach values\n"
                + "('Sach1',(SELECT MaSach From Sach Where MaSach='S001'),9,7),"
                + "('Sach2',(SELECT MaSach From Sach Where MaSach='S002'),7,7),"
                + "('Sach3',(SELECT MaSach From Sach Where MaSach='S003'),5,7)";
